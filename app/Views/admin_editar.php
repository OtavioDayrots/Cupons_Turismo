...
<head>
    ...
    <style>
        .container-editar { max-width: 600px; margin: 50px auto; padding: 30px; background: white; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
    ...
    <div class="container-editar">
        ...
        <form action="index.php?page=admin-update" method="POST">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;">
                ...
                <a href="index.php?page=admin" class="btn-cadastrar" style="background: #ccc; text-decoration: none; text-align: center;">Cancelar</a>
            </div>
        </form>
    </div>
